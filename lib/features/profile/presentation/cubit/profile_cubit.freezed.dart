...
mixin _$ProfileState {
 ...
 ProfileStatus get status; ProfileEntity? get profile; String? get error;
...
@useResult
$Res call({
 ProfileStatus status, ProfileEntity? profile, String? error
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProfileStatus status,  ProfileEntity? profile,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProfileStatus status,  ProfileEntity? profile,  String? error)  $default,) {final _that = this;
switch (_that) {
case _ProfileState():
return $default(_that.status,_that.profile,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProfileStatus status,  ProfileEntity? profile,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _ProfileState() when $default != null:
return $default(_that.status,_that.profile,_that.error);case _:
  return null;
...
class _ProfileState implements ProfileState {
  const _ProfileState({this.status = ProfileStatus.initial, this.profile = null, this.error = null});
  

@override@JsonKey() final  ProfileStatus status;
@override@JsonKey() final  ProfileEntity? profile;
