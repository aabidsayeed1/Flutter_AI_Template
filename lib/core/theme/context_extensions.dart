...
extension ContextExtension on BuildContext {
  AppThemeExtension get appTheme {
    ...
    assert(
      ext != null,
      'Ensure AppThemeExtension is added to ThemeData.extensions in AppTheme.',
    );
    return ext!;
  }
  ...
  ThemeRadiusExtension get radius => ThemeRadiusExtension(this);
...
class ThemeRadiusExtension {
  ThemeRadiusExtension(this.context);
...
class TypographyExtension {
  ...
  TextStyle get title => context.appTheme.typography.subtitle(context);
}
